...
(1, 'Handling of planning from design to building permit', 'Planning'),
(2, 'Construction supervision', 'Counseling'),
(3, 'Clarification of questions concerning building law', 'Counseling'),
(4, 'Coordination with other stakeholders (e.g. the building authority)', 'Counseling'),
(5, 'Continuous cost control', 'Financing');
...
--
ALTER TABLE `product`
  MODIFY `sap_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `product_customer`
--
ALTER TABLE `product_customer`
  MODIFY `procu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
